import 'package:mobo_manufacturing_app/LoginPage/pages/webview_screen.dart';
...
///
/// Accepts optional [url] and [database] used to send reset requests.
/// Displays email input, loading state, error handling, and success animation.
/// May redirect to web view if server requires browser-based reset.
...
/// • Reset password API communication
/// • Success and error UI states
/// • Success animation transitions
/// • Loading and navigation control
class _ResetPasswordScreenState extends State<ResetPasswordScreen>
  ...
  /// Initializes success animation controllers and animations.
  ///
  /// Sets up fade and slide animations for success message display.
  @override
  void initState() {
    super.initState();
  ...
  /// Disposes controllers used by this screen.
  ///
  /// Cleans up:
  ...
  /// Validates email and sends reset password request to server.
  ///
  /// Handles:
  /// • Form validation and email format check
  /// • Loading state management
  /// • API request using [ResetPasswordService]
  /// • Success animation trigger
  /// • WebView navigation if required by server
  /// • Haptic feedback for user interaction states
  ...
  /// Builds the reset password UI.
  ///
  /// Includes:
  /// • Background styling based on theme
  /// • Header section
  /// • Form or success message display
  /// • Back navigation control
  /// • Loading state protection during requests
  @override
  ...
  /// Builds the email input form and send button.
  ///
  /// Includes:
  /// • Email validation
  ...
  /// Builds the success message UI shown after email is sent.
  ///
  /// Displays:
  /// • Success icon
  /// • Confirmation title
  /// • Server response success message
  ...
  /// Builds button to navigate back to login screen.
  ///
  /// Pops current screen from navigation stack.
